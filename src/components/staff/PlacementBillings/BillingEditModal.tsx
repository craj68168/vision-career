      ...
      <div className="relative z-10 w-full max-w-2xl rounded-3xl bg-white shadow-2xl">
        <header className="flex items-start justify-between border-b border-slate-200 p-6">
          <div>
            ...
            <h2 className="mt-1 text-2xl font-bold">Edit Draft Billing</h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <label>
              ...
              <input
                ...
                className="mt-2 h-11 w-full rounded-xl border border-slate-200 px-3 outline-none focus:border-indigo-400"
              />
            </label>
